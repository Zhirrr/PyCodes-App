...
public class TenActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		textview1.setText("from PIL import ImageEnhance,Image,ImageChops \nimg = Image.open('YourPictures.jpg')\nEnhancer = ImageEnhance.Color( img )\nCimg = Enhancer.enhance(1.8)\nEnhancer = ImageEnhance.Brightness(Cimg)\nCimg = Enhancer.enhance(1.2)\nEnhancer = ImageEnhance.Sharpness(Cimg)\nCimg = Enhancer.enhance(1.5)\nCimg.save('/storage/emulated/0/YourPictures1.png')");
		textview11.setText("pip install PIL");
